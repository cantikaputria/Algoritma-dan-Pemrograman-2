...
{
    int n;                              //deklarasi variabel yang akan digunakan sebagai ketebalan
    ...
    for (i = 0; i < panjang; i++)
    {   
        ascii[i] = str[i];                                                 //memasukkan nilai ascii string ke variabel ascii
        ratusan = ascii[i] / 100;                                          //menghitung digit ratusan
        puluhan = (ascii[i] - ratusan * 100) / 10;                         //menghitung digit puluhan
        satuan  = (ascii[i] - ratusan * 100 - puluhan * 10);               //menghitung digit satuan

    //BARIS 1
    for (baris = 1; baris <= n; baris++)                                              
    {
        if ((ratusan == 2) || (ratusan == 3) ||                                 //ketika nilai ratusan = 2,3,5,6,8,9 maka..
        (ratusan == 5) || (ratusan == 6) || (ratusan == 8) || (ratusan == 9))
        {
            huruftengah(n);                                                //mengambil proses prosedur
            spasiangka(n);                                                 //mengambil proses prosedur
        }

        else if(ratusan == 1)                                               //ketika nilai ratusan = 1
        {
            hurufi(n);                                                       //mengambil proses prosedur
            spasiangka(n);                                                    //mengambil proses prosedur
        }

        else if(ratusan == 4)                                                //ketika nilai ratusan = 4
        {
            hurufkanankiri(n);                                              //mengambil proses prosedur
            spasiangka(n);                                                  //mengambil proses prosedur
        }           

        else if(ratusan == 7)                                               //ketika nilai ratusan = 1
        {
            hurufkirikiri(n);                                               //mengambil proses prosedur
            spasiangka(n);                                                  //mengambil proses prosedur
        }

        if ((puluhan == 0) || (puluhan == 2) || (puluhan == 3) ||                    //ketika nilai puluhan = sekian maka...
        (puluhan == 5) || (puluhan == 6) || (puluhan == 8) || (puluhan == 9))
        {
            huruftengah(n);                                                 //mengambil proses prosedur dst hingga selesai
            spasiangka(n);
        }
