...
int main ()
{
   ...
   char p;                       //deklarasi variabel p sebagai penanda
   char arr[p];                  //deklarasi array p sebagai penanda
   for (i = 0; i < n; i++)
   { 
   ...
   char q;                       //deklarasi variabel q sebagai penanda
   char arrr[q];                 //deklarasi array q sebagai penanda
   for (i = 0; i < m; i++)
   {
